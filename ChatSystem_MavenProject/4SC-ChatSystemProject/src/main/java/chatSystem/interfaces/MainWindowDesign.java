...
public class MainWindowDesign extends JFrame implements ListSelectionListener {
    private JLabel label;

    public MainWindowDesign() {
        super("MainWindowDesign");
        

        //Create an instance of SplitPaneDemo
        MainWindowDesign splitPaneDemo = new MainWindowDesign();
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new MainWindowDesign();
